...
class HostConfRegistry(type):
    ...
    def __new__(cls, name: str, bases: tuple[type[AbstractHostConfig]], attrs: dict) -> type[AbstractHostConfig]:
    ...
    @classmethod
    def _build_host_to_cls_map(cls, host_cls: type[AbstractHostConfig], hostnames: tuple[str, ...] | None) -> None:
